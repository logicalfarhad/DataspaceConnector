 ...
 * <p>
 * <ul>
 * <li>The class {@link io.dataspaceconnector.arx.AttributeType} encapsulates the four different kinds of attributes recognized by the framework.</li>
 * <li>The class {@link io.dataspaceconnector.arx.DataType} encapsulates the three different kinds of data types recognized by the framework.</li>
 * <li>The class {@link io.dataspaceconnector.arx.Data} represents an input dataset for the algorithm.</li>
